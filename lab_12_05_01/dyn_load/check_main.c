...
__declspec(dllimport) int __cdecl create_arr(int **begin, int count);
__declspec(dllimport) int __cdecl counting_elems(const int *begin, const int *end);
__declspec(dllimport) int *__cdecl filling_array(const int *begin, const int *end, int *index);
__declspec(dllimport) int __cdecl key(const int *pb_src, const int *pe_src, int **pb_dst, int **pe_dst);

__declspec(dllimport) int __cdecl counting_numbers(FILE *file, int *n);
__declspec(dllimport) int __cdecl read_array(FILE *file, int **begin, int **end);
__declspec(dllimport) void __cdecl output(FILE *file, int *begin, int *end);
__declspec(dllimport) int __cdecl counting(int *begin, int *end);

__declspec(dllimport) int __cdecl compare(const void *i, const void *j);
__declspec(dllimport) int __cdecl mysort(void *base, size_t num, size_t size, int (*compare)(const void *, const void *));
